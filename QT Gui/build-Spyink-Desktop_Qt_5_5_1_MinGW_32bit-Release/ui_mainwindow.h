...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        radio_reveal->setGeometry(QRect(310, 80, 117, 22));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        AppName->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:28pt; font-weight:600;\">SpyInk</span></p></body></html>", 0));
